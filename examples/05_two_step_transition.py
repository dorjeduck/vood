...
def main():
    ...
    middle_states = layouts.grid(start_states, cols=3, spacing_h=20, spacing_v=20)
    end_states = layouts.circle(
        start_states, radius=80, alignment=layouts.ElementAlignment.LAYOUT
    )
